            ...
            <tbody>
                <%
                    ...
                    try {
                        ...
                        String query = "SELECT grievance_id, student_regno, category, department, description, submission_date, status FROM grievances WHERE status = 'solved'";
